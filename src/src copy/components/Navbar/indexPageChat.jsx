        ...
        <NavLogoNew to='/' onClick={toggleHome}><ImgLogo src={img} alt={alt} /> </NavLogoNew>
          ...
          <NavMenuBChat>
          {
            authUser  ? (
              ...
              <> 
              <NavBtnI>
                <NavBtnLinkI to='/User'><CgProfile style={{ color: '#040404', marginBottom: '3px' }}/>  Profile</NavBtnLinkI>
              </NavBtnI>
    
              <NavBtnI>
              <NavBtnLinkI to='/chat'> <MdChatBubble style={{ color: '#040404', marginBottom: '3px' }}/>  My Chat</NavBtnLinkI>
              </NavBtnI>

              <NavBtnI>
                <NavBtnLinkI to='/newsfeed'><FaNewspaper style={{ color: '#040404', marginBottom: '3px' }}/>  NewsFeed</NavBtnLinkI>
              </NavBtnI>
              </>
          )    :  (
            <NavBtnI>
