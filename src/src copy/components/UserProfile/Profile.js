  ...
  return (
    ...
    {nameFilter.map(user => (
      <Card  style={{padding: "3px", maxHeight:"30rem", maxWidth:"20rem" }}>
        ...
        <Card.Body>
          <Card style={{marginLeft: "1.5rem",  width: "180px",
  height: "180px", borderRadius: "100%", overflow: "hidden" }} >
    <CardImg src={img} alt={alt}/></Card> 
      
        <Card.Title style={{marginTop: "25px", fontSize:"30px", fontWeight:"bold"}}>{user.userName} {error && <Alert variant="danger">{error}</Alert>}
        </Card.Title>
